...
const createQuestion = ({ question, correctAnswer, incorrectAnswers,}:QuestionResponse ) => {
    ...
    $form.addEventListener('submit', (event) => {
        ...
        const answer = $form.querySelector('input[name="answer"]:checked') as unknown as string  ;
